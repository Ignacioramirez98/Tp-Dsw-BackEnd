...
App backend desarrollada para la facultad UTN en la materia de Desarrollo de Software 2024.
...
⚠️ **IMPORTANTE para Producción:** Cambiar `JWT_SECRET` a un valor seguro.
