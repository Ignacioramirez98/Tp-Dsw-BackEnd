...
async function add(req, res) {
    ...
    const clienteInput = new Cliente(input.nombre, input.apellido, input.dni, input.mail, input.telefono, input.direccion, input.razon_social, input.usuario, hashedPassword);
